...
export const config = {
  ...
  capabilities: [
    {
      ...
      "goog:chromeOptions": {
        args: process.env.CI ? ["--headless=new", "--no-sandbox", "--disable-gpu", "--window-size=1920,1080"] : [],
      },
      "moz:firefoxOptions": {
        args: ["-headless"],
      },
  ...
  afterTest: async function (test, context, { passed }) {
    if (!passed) {
      ...
      allureReporter.addAttachment(`Screenshot - ${cleanTitle}`, Buffer.from(screenshot, "base64"), "image/png");
    }
  },
